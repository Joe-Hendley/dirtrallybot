...
// Bot parameters
var (
	GuildID  = flag.String("guild", "766023693054509076", "Test guild ID")
	BotToken = flag.String("token", "MTEwNDQxODY3NjM1NjE1NzU3Mw.GhAdpT.4be-k6z_II-bsacMfuajWiT-ccTPC3PYEZy280", "Bot access token")
	AppID    = flag.String("app", "1104418676356157573", "Application ID")
)
